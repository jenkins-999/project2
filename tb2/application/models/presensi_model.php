...
class presensi_model extends CI_Model
{
	...
	public function laporan($id_karyawan = '', $bulan = '')
	{
		...
		if ($bulan != '') {
			$this->db->where('DATE_FORMAT(tanggal_masuk,"%m")', $bulan);
		}
	...
	public function get_data_presensi($id_karyawan = '', $bulan = '')
	{
		//sql read
		//sql read
		$bulan = date('d ');
		...
		if ($bulan != '') {
			$this->db->where('DATE_FORMAT(tanggal_masuk,"%d")', $bulan);
		}
		...
		$this->db->select('COUNT(id_karyawan) AS data_presensi');
